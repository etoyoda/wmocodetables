...
|GRIB符号表(除4.1,4.2) |1個CSV |1個CSV |1個CSV |_s.n.d.k_
|GRIB符号表4.1 |1個CSV |_d_ 毎分割 |_d_ 毎分割 |_d_
|GRIB符号表4.2 |_d.k_ 結合 |1個CSV |1個CSV |_d.k_
|BUFR表A |1個CSV |{mdash} |1個CSV |{mdash}
|BUFR/CREX表B |_XX_ 結合 |1個CSV |1個CSV |_XX_
|BUFR表C |1個CSV |{mdash} |1個CSV |{mdash}
|BUFR表D |_XX,FXY_ 結合 |1個CSV |_FXY_ 毎分割 |_XX,FXY_
|BUFR/CREX符号・フラグ表 |_XX_ 結合 |1個CSV |_FXY_ 毎分割 |_XX,FXY_
|CREX表A |1個CSV |{mdash} |1個CSV |{mdash}
|CREX表C |1個CSV |{mdash} |1個CSV |{mdash}
|CREX表D |_XX,FXY_ 結合 |1個CSV |_FXY_ 毎分割 |_XX,FXY_
|共通符号表(除C06) |1個CSV |1個CSV |1個CSV |_cc_
|共通符号表C06 |1個CSV |1個CSV |UnitType 毎分割 |_cc_
|===
